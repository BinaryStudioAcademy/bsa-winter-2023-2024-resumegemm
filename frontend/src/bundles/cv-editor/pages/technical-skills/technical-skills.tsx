...
const technicalSkillsOptions = [
    { value: TechnicalSkillLevel.BEGINNER, label: TechnicalSkillLevel.BEGINNER },
    { value: TechnicalSkillLevel.EXPERIENCED, label: TechnicalSkillLevel.EXPERIENCED },
